function crear_informacion_uso() {
    ...
    let textos = [
        ...
        '* Para buscar un pokemon debes hacer click en la icono de lupa justo al cerrar sesion.',
        ...
        '* Estos textos de ayuda al darles click se plasmaran en el campo para no tengas necesidad de escribir el nombre.',
        ...
        '* Cuando haya aparecido el imagen con el nombre del respectivo pokemon, debes darle click para que aparezca el panel con sus propiedades',
